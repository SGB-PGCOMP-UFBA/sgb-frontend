...
function DialogResetarSenhaOrientador({ item, isOpen, onClose, onSubmit }: DialogResetarSenhaOrientadorProps) {
  ...
  const dialogContent = (
    <div className="mt-2 flex min-w-[395px] max-w-[595px] flex-col font-inter">
      ...
      <br/>
      <p>Ele(a) receberá uma nova senha no e-mail informado em seu cadastro nesta plataforma.</p>
    </div>
  )
