...
export interface CardBolsasFapesbViewProps {
  className?: string
  data: CountByAgencyAndStatus[string]
  isLoading: boolean
}

function CardBolsasFapesbView(props: CardBolsasFapesbViewProps) {
      ...
      <CardContent className='flex h-full w-full flex-col justify-between overflow-hidden p-6'>
        <div className='mb-4 flex flex-row items-start justify-between gap-6'>
          <div className='mb-4 flex flex-col'>
            <h3 className='mb-10 text-2xl font-bold text-foreground'>FAPESB</h3>
