...
/**
 * Artigos ainda nao existem no backend: nenhum mapper de Student devolve este
 * campo, entao o bloco de publicacoes nunca renderiza hoje. Tipado como
 * opcional para preservar a tela como esta, sem fingir que o dado chega.
 */
